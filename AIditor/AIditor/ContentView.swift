...
final class AppModel: ObservableObject {
    ...
    func verifyExport() async {
        ...
        let directory = URL(fileURLWithPath: NSTemporaryDirectory())
            .appendingPathComponent("AIditorExportCheck", isDirectory: true)
    ...
    func verifyAudioMixExport() async {
        ...
        let directory = URL(fileURLWithPath: NSTemporaryDirectory())
            .appendingPathComponent("AIditorMixCheck", isDirectory: true)
        try? FileManager.default.createDirectory(at: directory,
                                                 withIntermediateDirectories: true)
    ...
    func verifyTransitionExport() async {
        ...
        let directory = URL(fileURLWithPath: NSTemporaryDirectory())
            .appendingPathComponent("AIditorTransitionCheck", isDirectory: true)
        try? FileManager.default.createDirectory(at: directory,
                                                 withIntermediateDirectories: true)
    ...
    func runTransitionGPUPlayback(enabled: Bool) async {
        ...
        let marker = URL(fileURLWithPath: NSTemporaryDirectory())
            .appendingPathComponent("AIditorGPUPlayback.marker")
    ...
    func verifyTitleExport() async {
        ...
        let directory = URL(fileURLWithPath: NSTemporaryDirectory())
            .appendingPathComponent("AIditorTitleCheck", isDirectory: true)
        try? FileManager.default.createDirectory(at: directory,
                                                 withIntermediateDirectories: true)
    ...
    func verifyPhotoExport() async {
        ...
        let directory = URL(fileURLWithPath: NSTemporaryDirectory())
            .appendingPathComponent("AIditorPhotoCheck", isDirectory: true)
        try? FileManager.default.createDirectory(at: directory,
                                                 withIntermediateDirectories: true)
    ...
    func verifyColorExport() async {
        ...
        let directory = URL(fileURLWithPath: NSTemporaryDirectory())
            .appendingPathComponent("AIditorColorCheck", isDirectory: true)
        try? FileManager.default.createDirectory(at: directory,
                                                 withIntermediateDirectories: true)
    ...
    func verifyMusicImport() async {
        let directory = URL(fileURLWithPath: NSTemporaryDirectory())
            .appendingPathComponent("AIditorMusicCheck", isDirectory: true)
        try? FileManager.default.createDirectory(at: directory,
                                                 withIntermediateDirectories: true)
    ...
    func verifySharpness() async {
        let directory = URL(fileURLWithPath: NSTemporaryDirectory())
            .appendingPathComponent("AIditorSharpCheck", isDirectory: true)
        try? FileManager.default.createDirectory(at: directory,
                                                 withIntermediateDirectories: true)
    ...
    func verifyEmptiness() async {
        let directory = URL(fileURLWithPath: NSTemporaryDirectory())
            .appendingPathComponent("AIditorEmptyCheck", isDirectory: true)
        try? FileManager.default.createDirectory(at: directory,
                                                 withIntermediateDirectories: true)
    ...
    func verifyAudioFades() async {
        ...
        let directory = URL(fileURLWithPath: NSTemporaryDirectory())
            .appendingPathComponent("AIditorFadeCheck", isDirectory: true)
        try? FileManager.default.createDirectory(at: directory,
                                                 withIntermediateDirectories: true)
    ...
    func verifyChronologyAndRange() async {
        ...
        let directory = URL(fileURLWithPath: NSTemporaryDirectory())
            .appendingPathComponent("AIditorRangeCheck", isDirectory: true)
    ...
    func verifyNormalizedExport() async {
        ...
        let directory = URL(fileURLWithPath: NSTemporaryDirectory())
            .appendingPathComponent("AIditorNormalizeCheck", isDirectory: true)
        try? FileManager.default.createDirectory(at: directory,
                                                 withIntermediateDirectories: true)
    ...
    func runBenchmark(only paths: [String] = []) async {
        ...
        reportLines = lines
        status = "Hotovo."
        writeReport(lines, to: "AIditorBenchmark.txt")
    ...
    func runFullScreenComparison(only paths: [String] = []) async {
        ...
        reportLines = lines
        status = "Hotovo."
        writeReport(lines, to: "AIditorFullScreen.txt")
        for line in lines { print(line) }
    }
    ...
    func runTimelineStressBench(pairs: Int = 1000) async {
        ...
        status = "Hotovo."
        writeReport(result.report, to: "AIditorTimelineBench.txt")
...
struct ContentView: View {
    /// Model vlastní `AIditorApp` — menu (⌘S, ⌘O) potřebuje tentýž objekt.
