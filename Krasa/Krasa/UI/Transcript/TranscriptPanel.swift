...
//  Zdroj zadání: `design_handoff_krasa_ui/README.md`, obrazovka 4.
//
...
struct TranscriptPanel: View {
                        ...
                        ZStack {
                            Circle()
                                .strokeBorder(stage.isDone ? KrasaUI.ok
                                              : (stage.isRunning ? KrasaUI.accent
                                                 : KrasaUI.borderActive), lineWidth: 1.5)
    ...
    private func selectedCard(_ item: SegmentItem) -> some View {
        ...
        .background(RoundedRectangle(cornerRadius: 8).fill(KrasaUI.surfaceControl))
        .overlay(RoundedRectangle(cornerRadius: 8)
            .strokeBorder(KrasaUI.accent, lineWidth: 1))
    }
            ...
            HStack(spacing: 8) {
                Text("\(allSegments.count) úseků")
                    ...
                    .background(RoundedRectangle(cornerRadius: KrasaUI.Metric.chipRadius)
                        .fill(KrasaUI.surfaceControlActive))
    ...
    var body: some View {
        Button(action: action) {
            Text(title)
                ...
                .overlay(RoundedRectangle(cornerRadius: KrasaUI.Metric.chipRadius)
